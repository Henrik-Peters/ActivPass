...
namespace ActivPass.Localization
{
    public class TranslateManager
    {
        ...
        {
            ["AutoClearClipboardAfter"] = new List<string> { "Automatically clear clipboard after", "Automatisch Zwischenablage bereinigen nach" },
            ...
            ["ContainerReportTitle"] = new List<string> { "ActivPass - Container report", "ActivPass - Container Report" },
            ["BackupDialogTitle"] = new List<string> { "Save encrypted container", "Verschlüsselten Container speichern" },
            ["BackupContainer"] = new List<string> { "Backup", "Datensicherung" },
            ...
            ["LowercaseLetters"] = new List<string> { "Lowercase letters", "Kleinbuchstaben" },
            ["CapitalLetters"] = new List<string> { "Capital letters", "Großbuchstaben" },
            ["Options"] = new List<string> { "Options", "Optionen" },
            ["PasswordDuplicat"] = new List<string> { "Password duplicate", "Password Duplikat" },
            ...
            ["VeryWeak"] = new List<string> { "Very weak", "Sehr schwach" },
            ["Weak"] = new List<string> { "Weak", "Schwach" },
            ["Medium"] = new List<string> { "Medium", "Mittel" },
            ["Strong"] = new List<string> { "Strong", "Sehr stark" },
            ["VeryStrong"] = new List<string> { "Very strong", "Sehr stark" },
            ["ExtremeStrong"] = new List<string> { "Extremely strong", "Extrem stark" },
